                                              ...
                                              $instagram = $_SESSION["instagram"];
                                                ...
                                                include_once PATH_HELPERS .'/database_helper.php';
                                                   $conexion = getConexion();
                                                      ...
                                                      $sql = "UPDATE usuarios SET usr_nombre = '$nombre', usr_tel = '$telefono', usr_edad = '$edad', usr_foto = '$foto', usr_facebook = '$facebook', usr_twitter = '$twitter', usr_instagram = '$instagram' WHERE usr_id = " . $_SESSION["id_usuario"];
