    ...
    <div class="container mt-3">
    	<div class="row">
    		<div class="col-4 ">
				<div class="container border border border-dark bg-dark shadow-lg text-white">
					...
					<form action="index.php">
							...
							<input type="hidden" name="tipo" value="profe">
				    			...
				    			<div class="form-group">				    			  	 		
					  			...
					  			<input type="submit" name="submit" value="Buscar" class="btn btn-info col-12">
    		...
    		<div class="col-8 border shadow-lg p-3 mb-5 bg-white rounded busprofe">
